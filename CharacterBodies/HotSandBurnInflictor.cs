...
{
    public class HotSandBurnInflictor : BaseCharacterBody
    {
        public override void OnPluginAwake()
        {
            base.OnPluginAwake();
            prefab = Utils.CreateBlankPrefab("MysticsItems_HotSandBurnInflictorBody", true);
        ...
        public override void OnLoad()
        {
            ...
            bodyName = "ChallengeMode_HotSandBurnInflictor";
            ...
            characterBody.portraitIcon = Addressables.LoadAssetAsync<BuffDef>("RoR2/Base/Common/bdOnFire.asset").WaitForCompletion().iconSprite.texture;
